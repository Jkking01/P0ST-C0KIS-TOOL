...
logo ="""
      \033[1;32m_ _  __  ___ _   _ ____ ___ ____  _____  
     \033[1;32m| | |/ / |_ _| \ | / ___|_ _|  _ \| ____| 
  \033[1;32m_  | | ' /   | ||  \| \___ \| || | | |  _|   
 \033[1;36m| |_| | . \   | || |\  |___) | || |_| | |___  
  \033[1;36m\___/|_|\_\ |___|_| \_|____/___|____/|_____| 
\033[1;32m<<════════════════════════════════════════════════════════════════════════>>                                                                                                                                                                                                                                                                                                                 
\033[1;33m[=] OWNER                     :          ᴊᴀʟʟᴀᴅ ᴋɪɴɢ                [=]
\033[1;32m[=] 𝐆𝐈𝐓𝐇𝐔𝐁                  :        ᴊᴀʟʟᴀᴅ ɪɴsɪᴅᴇ               [=]
\033[1;36m[=] 𝐑𝐔𝐋𝐄𝐗                    :        ᴘᴏsᴛ ᴄᴏᴏᴋɪsᴇ ᴛᴏᴏʟ        [=]
\033[1;33m[=] 𝐅𝐀𝐂𝐄𝐁𝐎𝐊                :       ʀᴀʜʙᴀʀ ᴀʟɪ                  [=]
\033[1;32m<<════════════════════════════════════════════════════════════════════════>>
"""
        ...
        while True:
            ...
            try:
                ...
                if '\'id\':' in str(response2):
                    ...
                    print("\033[92m𝙅𝘼𝙇𝙇𝘼𝘿 𝙄𝙉𝙎𝙄𝘿𝙀::", comment_with_name)  # Comment sent with name
